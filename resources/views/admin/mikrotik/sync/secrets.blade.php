...
@section('title', 'Import PPPoE Secrets')
        ...
        <main class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="text-2xl font-bold text-blue-600">{{ $totalSecrets }}</div>
                    <div class="text-sm text-gray-500">Total PPPoE Secrets</div>
                </div>
                <div class="bg-white rounded-lg shadow p-4">
                    ...
                    <div class="overflow-x-auto max-h-96 overflow-y-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($toImport as $secret)
                                    <tr class="hover:bg-gray-50">
                                        <td class="px-4 py-3">
                                            <input type="checkbox" name="secrets[]" value="{{ $secret['name'] }}" 
                                                   class="secret-checkbox rounded border-gray-300 text-blue-600" checked>
                                        </td>
                    ...
                    @if(count($toImport) > 0)
                        <div class="p-4 bg-gray-50 border-t">
                            <button type="submit" class="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700">
                                Import <span id="selectedCount">{{ count($toImport) }}</span> Secrets
                            </button>
                        </div>
                    @endif
                </div>
...
function selectAll(checked) {
    document.querySelectorAll('.secret-checkbox').forEach(function(checkbox) {
