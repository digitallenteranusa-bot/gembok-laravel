...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/invoices-bulk', [InvoiceController::class, 'bulkGenerateForm'])->name('invoices.bulk.form');
        Route::post('/invoices-bulk/preview', [InvoiceController::class, 'bulkGeneratePreview'])->name('invoices.bulk.preview');
        Route::post('/invoices-bulk', [InvoiceController::class, 'bulkGenerate'])->name('invoices.bulk.generate');

        // Debt Report & Management
        Route::get('/debt-report', [InvoiceController::class, 'debtReport'])->name('invoices.debt-report');
        Route::get('/debt-report/customer/{customer}', [InvoiceController::class, 'customerDebt'])->name('invoices.customer-debt');
        Route::post('/invoices/{invoice}/record-payment', [InvoiceController::class, 'recordPayment'])->name('invoices.record-payment');
        Route::post('/debt-report/recalculate', [InvoiceController::class, 'recalculateAllDebts'])->name('invoices.recalculate-debts');

        // Installment Plan
        Route::get('/invoices/{invoice}/installment', [InvoiceController::class, 'createInstallmentForm'])->name('invoices.installment.form');
        Route::post('/invoices/{invoice}/installment', [InvoiceController::class, 'storeInstallment'])->name('invoices.installment.store');
