...
class CustomerController extends Controller
{
    ...
    {
        return CustomersExport::downloadTemplate();
    }
    ...
    public function import(Request $request)
    {
        ...
        $results = $importer->import($request->file('file'));

        $message = "Import selesai: {$results['success']} berhasil, {$results['failed']} gagal, {$results['skipped']} di-skip.";
